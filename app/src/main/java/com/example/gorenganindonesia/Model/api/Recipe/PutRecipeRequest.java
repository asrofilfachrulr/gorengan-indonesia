...
public class PutRecipeRequest {
    ...
    public PutRecipeRequest() {}

    public PutRecipeRequest(String title, String category, int minuteDuration, String difficulty, int portion, IngredientData[] ingredients, StepData[] steps) {
        this.title = title;
